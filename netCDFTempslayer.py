...
inCDF = "../data/cov/minTempNCDF/tmmn_2006.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_2006fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_2006.tif" #Multiband .tif created from netCDF
