...
inCDF = "../data/cov/minTempNCDF/tmmn_2012.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_2012fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_2012.tif" #Multiband .tif created from netCDF
