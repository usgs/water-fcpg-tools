...
inCDF = "../data/cov/minTempNCDF/tmmn_1995.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_1995fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_1995.tif" #Multiband .tif created from netCDF
