...
inCDF = "../data/cov/minTempNCDF/tmmn_2016.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_2016fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_2016.tif" #Multiband .tif created from netCDF
