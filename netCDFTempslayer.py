...
inCDF = "../data/cov/minTempNCDF/tmmn_1981.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_1981fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_1981.tif" #Multiband .tif created from netCDF
