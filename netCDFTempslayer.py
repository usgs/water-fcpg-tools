...
inCDF = "../data/cov/minTempNCDF/tmmn_2014.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_2014fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_2014.tif" #Multiband .tif created from netCDF
