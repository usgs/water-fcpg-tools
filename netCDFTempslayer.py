...
inCDF = "../data/cov/minTempNCDF/tmmn_2004.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_2004fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_2004.tif" #Multiband .tif created from netCDF
