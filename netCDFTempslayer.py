...
inCDF = "../data/cov/minTempNCDF/tmmn_2008.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_2008fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_2008.tif" #Multiband .tif created from netCDF
