...
inCDF = "../data/cov/minTempNCDF/tmmn_1999.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_1999fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_1999.tif" #Multiband .tif created from netCDF
