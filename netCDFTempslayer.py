...
inCDF = "../data/cov/minTempNCDF/tmmn_2011.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_2011fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_2011.tif" #Multiband .tif created from netCDF
