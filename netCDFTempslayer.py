...
inCDF = "../data/cov/minTempNCDF/tmmn_1990.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_1990fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_1990.tif" #Multiband .tif created from netCDF
