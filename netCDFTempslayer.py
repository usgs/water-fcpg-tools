...
inCDF = "../data/cov/minTempNCDF/tmmn_1988.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_1988fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_1988.tif" #Multiband .tif created from netCDF
