...
inCDF = "../data/cov/minTempNCDF/tmmn_2005.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_2005fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_2005.tif" #Multiband .tif created from netCDF
