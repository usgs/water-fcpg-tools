...
inCDF = "../data/cov/minTempNCDF/tmmn_1983.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_1983fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_1983.tif" #Multiband .tif created from netCDF
