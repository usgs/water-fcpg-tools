...
inCDF = "../data/cov/minTempNCDF/tmmn_2007.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_2007fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_2007.tif" #Multiband .tif created from netCDF
