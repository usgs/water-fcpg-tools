...
inCDF = "../data/cov/minTempNCDF/tmmn_2009.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_2009fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_2009.tif" #Multiband .tif created from netCDF
