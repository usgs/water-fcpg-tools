...
inCDF = "../data/cov/minTempNCDF/tmmn_1985.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_1985fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_1985.tif" #Multiband .tif created from netCDF
