...
inCDF = "../data/cov/minTempNCDF/tmmn_2003.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_2003fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_2003.tif" #Multiband .tif created from netCDF
