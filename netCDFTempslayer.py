...
inCDF = "../data/cov/minTempNCDF/tmmn_1984.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_1984fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_1984.tif" #Multiband .tif created from netCDF
