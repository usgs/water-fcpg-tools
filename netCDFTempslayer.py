...
inCDF = "../data/cov/minTempNCDF/tmmn_1996.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_1996fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_1996.tif" #Multiband .tif created from netCDF
