...
inCDF = "../data/cov/minTempNCDF/tmmn_2010.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_2010fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_2010.tif" #Multiband .tif created from netCDF
