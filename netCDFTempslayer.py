...
inCDF = "../data/cov/minTempNCDF/tmmn_1993.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_1993fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_1993.tif" #Multiband .tif created from netCDF
