...
inCDF = "../data/cov/minTempNCDF/tmmn_1989.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_1989fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_1989.tif" #Multiband .tif created from netCDF
