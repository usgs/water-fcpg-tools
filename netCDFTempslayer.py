...
inCDF = "../data/cov/minTempNCDF/tmmn_2000.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_2000fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_2000.tif" #Multiband .tif created from netCDF
