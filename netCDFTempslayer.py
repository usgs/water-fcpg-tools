...
inCDF = "../data/cov/minTempNCDF/tmmn_1980.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_1980fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_1980.tif" #Multiband .tif created from netCDF
