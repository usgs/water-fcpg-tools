...
inCDF = "../data/cov/minTempNCDF/tmmn_2013.nc" #Original netCDF from gridMET
reorderCDF = "../data/cov/minTempNCDF/tmmn_2013fix.nc" #NetCDF file with reordered dimensions
multiTIFF = "../data/cov/minTempNCDF/tmmn_2013.tif" #Multiband .tif created from netCDF
